...
- Rates are `RATE_BEES` 1 · `LIKE_BEES` 1 · `COMMENT_BEES` 2 — deliberately small, because Bees are money (100 = $1) and these are taps. Treat a change here as a pricing change, not a tweak.
