...
const routes = [
    ...
    { path: '/admin/hive/challenges', name: 'admin-hive-challenges', component: () => import('./pages/HiveChallenges.vue') },
    { path: '/admin/hive',       name: 'admin-hive',      component: () => import('./pages/HiveReports.vue') },
    { path: '/admin/ai',         name: 'admin-ai-studio', component: () => import('./pages/AiStudio.vue') },
    { path: '/admin/ai-usage',   name: 'admin-ai-usage',  component: () => import('./pages/AiUsage.vue') },
