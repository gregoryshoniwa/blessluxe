...
<template>
    <div v-if="hive.gateOpen" class="fixed inset-0 z-[95] flex items-end sm:items-center justify-center" role="dialog" aria-modal="true" aria-label="Confirm your age">
        ...
        <div class="relative bg-white w-full sm:max-w-md p-6 pb-[max(1.5rem,env(safe-area-inset-bottom))] shadow-2xl">
            ...
            <label class="flex items-start gap-3 p-3.5 border border-black/10 cursor-pointer mb-5">
