...
<head>
    <meta charset="utf-8">
    <title>Reset your BLESSLUXE password</title>
</head>
        ...
        <tr><td align="center">
            <table role="presentation" width="560" cellspacing="0" cellpadding="0" style="background:#ffffff;border-top:3px solid #C9A84C;">
                <tr><td style="padding:48px 48px 0;text-align:center;">
                    ...
                    <p style="font-size:10px;letter-spacing:.32em;text-transform:uppercase;color:#666;margin:14px 0 0;">Password reset</p>
                </td></tr>
                <tr><td style="padding:36px 48px;">
                    <h2 style="font-family:'Georgia',serif;font-size:26px;font-weight:500;color:#000;margin:0 0 16px;">Reset your password, {{ $firstName }}.</h2>
                    <p style="line-height:1.6;color:#444;margin:0 0 28px;">
                        We received a request to reset the password for your BLESSLUXE account. This link expires in 60 minutes.
                    </p>
                    <p style="margin:0 0 28px;">
                        <a href="{{ $resetUrl }}" style="display:inline-block;background:#C9A84C;color:#fff;text-decoration:none;padding:14px 36px;font-size:11px;letter-spacing:.3em;text-transform:uppercase;font-weight:600;">Reset password</a>
                    </p>
                    <p style="font-size:13px;line-height:1.5;color:#666;margin:0 0 8px;">Or paste this link into your browser:</p>
                    <p style="font-size:12px;line-height:1.5;color:#888;word-break:break-all;margin:0 0 24px;">{{ $resetUrl }}</p>
